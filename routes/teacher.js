...
router.post('/addCourse',imageUpload.single('fuImage'),isAuth,teacherController.postAddCourse);
...
router.post('/course/upload/:cid',videoUpload.single('fuVideo'),isAuth,teacherController.postUpload);
