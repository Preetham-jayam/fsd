...
router.post('/student/edit-password',isAuth,studentController.postPasswordedit);
router.post('/student/profile/edit',profileUpload.single('profile'),isAuth,studentController.postProfileEdit);
